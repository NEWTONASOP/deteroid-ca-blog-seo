        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 bg-white rounded-2xl p-6 md:p-9 border border-gray-200 shadow-md">
            ...
            <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-5">
              ...
              <div className="flex items-center gap-2.5 ml-auto">
                ...
                <button 
                  title="LinkedIn"
                  className="w-7.5 h-7.5 rounded bg-gray-50 hover:bg-blue-600 hover:text-white text-gray-600 flex items-center justify-center transition-all duration-300 border border-gray-200"
                >
                ...
                <button 
                  title="WhatsApp"
                  className="w-7.5 h-7.5 rounded bg-gray-50 hover:bg-emerald-600 hover:text-white text-gray-600 flex items-center justify-center transition-all duration-300 border border-gray-200"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <button 
                  title="Twitter"
                  className="w-7.5 h-7.5 rounded bg-gray-50 hover:bg-black hover:text-white text-gray-600 flex items-center justify-center transition-all duration-300 border border-gray-200"
                >
          ...
          <aside className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-6 text-white text-center border border-blue-950 shadow-md relative overflow-hidden">
              ...
              <form className="space-y-2.5 relative z-10">
                <input 
                  type="email" 
                  placeholder="Professional Email Address" 
                  className="w-full px-3.5 py-2.5 rounded bg-white/10 border border-white/10 text-white placeholder-gray-400 text-xs focus:outline-none focus:border-blue-700 focus:bg-white focus:text-gray-900 transition-all font-bold" 
                />
                <button className="w-full py-2.5 bg-white text-blue-900 font-extrabold rounded hover:bg-gray-100 transition-colors text-xs uppercase tracking-wider">
                  Subscribe Now
                </button>
              </form>
            </div>
