...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = siteSettings?.metaTitle || `Blog & Insights | ${siteName}`
  const description =
    siteSettings?.metaDescription ||
    'Expert compliance updates, GST news, tax guidelines, and business insights from the CAs at Shalini Arora & Company.'

  let ogImageUrl: string | null = null
  if (siteSettings?.defaultShareImage) {
